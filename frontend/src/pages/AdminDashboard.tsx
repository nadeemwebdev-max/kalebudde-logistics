...
export default function AdminDashboard() {
  ...
  return (
    <>
      ...
      {/* NEW SHIPMENT MODAL */}
      {modal === "shipment" && (
        <Modal title="Create New Consignment Entry" subtitle="Enter manual LR number and consignment details" onClose={() => setModal(null)}>
          <form onSubmit={createShipment} className="space-y-4">
            <div className="bg-brand-50 border border-brand-200 rounded-xl p-3 text-xs text-brand-900 flex items-center justify-between">
              <div>
                <strong className="block text-brand-950 font-bold">Consignment Tracking Number:</strong>
                <span className="text-brand-700">Will be automatically generated by system (e.g. KLXXXXXXXXX)</span>
              </div>
              <span className="rounded-lg bg-brand-900 px-2.5 py-1 text-[11px] font-mono font-bold text-white shadow">Auto-Generated</span>
            </div>

            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label className="label font-bold text-brand-900">Manual LR Number (Paper Lorry Receipt No)</label>
